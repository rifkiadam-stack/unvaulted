...
| 014 | Context menu (mode-aware) + formatting shortcuts + File menu + real Save As | P2 | M | 013 | DONE (PASS — reviewer-confirmed 2026-07-18; operator smoke green; "New" added post-merge by reviewer, operator-authorized) |
