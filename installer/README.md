...
Download **`Unvaulted_0.1.0_x64-setup.exe`** from this folder and run it. No need to clone the repo.

- Windows 10/11, 64-bit.
- Windows SmartScreen will warn "Windows protected your PC" (the installer isn't code-signed) — click **More info → Run anyway**.
